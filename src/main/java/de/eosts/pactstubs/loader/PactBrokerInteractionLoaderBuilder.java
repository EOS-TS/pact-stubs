...
public class PactBrokerInteractionLoaderBuilder {
    ...
    public PactInteractionLoader build() {
        if (pactBrokerTags != null) {
            return new PactInteractionLoader(new PactBrokerLoader(pactBrokerHost, pactBrokerPort, pactBrokerProtocol, pactBrokerTags, pactBrokerConsumers, true, pactBrokerAuth, null, null));
        } else {
            return new PactInteractionLoader(new PactBrokerLoader(pactBrokerHost, pactBrokerPort, pactBrokerProtocol, Collections.singletonList("latest"), pactBrokerConsumers, true, pactBrokerAuth, null, null));
        }
    }
}
